...
// This functions outputs a list of all existing order data.
function list(req, res, next) {
  res.send({ data: orders });
}

//This function validates the order's deliverTo property. It will check:
...
//This function validates the order's mobile number property. It will check:
...
//This function validates the order's dishes property. It will check:
...
//This function checks if the order exists. If it does, it'll move onto the next function. But if no matching order is found, it wil return 404.
...
//This function validates of the route id matches the dataId if a dataId is given in the update object.
...
//This function validates the status property of an update. It will check:
//1. if the status is property is missing 2. if the status property is empty and 3. if the status property of an existin order === "delivered".
